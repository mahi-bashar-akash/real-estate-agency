                        ...
                        <span class="flex justify-center items-center">
                            ...
                            <svg viewBox="0 0 24 24" class="size-[26px] ms-3" fill="none"
                                ...
                                <g id="SVGRepo_iconCarrier">
                                    <path class="stroke-white" d="M5 12H19M19 12L13 6M19 12L13 18" stroke-width="2"
                                ...
                                <svg viewBox="0 0 20 20" class="size-[20px]" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <g id="SVGRepo_iconCarrier">
                                        <path fill="#000000" fill-rule="evenodd"
                                              d="M3 10a7 7 0 019.307-6.611 1 1 0 00.658-1.889 9 9 0 105.98 7.501 1 1 0 00-1.988.22A7 7 0 113 10zm14.75-5.338a1 1 0 00-1.5-1.324l-6.435 7.28-3.183-2.593a1 1 0 00-1.264 1.55l3.929 3.2a1 1 0 001.38-.113l7.072-8z"></path>
                                    </g>
                                </svg>
                            </div>
                       ...
                       class="inline-block px-7 sm:px-10 py-3 sm:py-5 decoration-0 outline-0 border-0 bg-white rounded-[50px] text-black duration-500 hover:bg-white/70">
                        <span class="flex justify-center items-center">
                            ...
                            <svg viewBox="0 0 24 24" class="size-[26px] ms-3" fill="none"
                                ...
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                                    <path class="stroke-black" d="M5 12H19M19 12L13 6M19 12L13 18" stroke-width="2"
                                          stroke-linecap="round" stroke-linejoin="round"></path>
                                </g>
                            </svg>
                        </span>
                    ...
                    <form class="w-full flex flex-wrap">
                        ...
                        <div class="mb-4">
                            <button type="submit"
                                ...
                                <span class="flex justify-center items-center">
                                    Send Message
                                    <svg viewBox="0 0 24 24" class="ms-4 size-[24px]" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            ...
                            <div class="my-3 flex gap-2 items-start leading-6 text-gray-700">
                                <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <g id="SVGRepo_iconCarrier">
                                        ...
                                        <path
                                            d="M8 8a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm0 1a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"></path>
                                    </g>
                                </svg>
                                    ...
                                    <span class="flex justify-center items-center">
                                        ...
                                        <svg viewBox="0 0 24 24" class="size-[26px] ms-3" fill="none"
                                            ...
                                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                               stroke-linejoin="round"></g>
                                            <g id="SVGRepo_iconCarrier">
                                                <path class="stroke-black duration-500 group-hover/item:stroke-white"
        ...
        <div class="mx-auto lg:max-w-[1000px] xl:max-w-[1400px] px-3 py-2 sm:px-2 sm:py-0">
            <div class="w-full py-5 sm:py-10 flex flex-wrap items-center">
                <div class="w-full lg:w-1/2 p-3">
                    ...
                    <div class="text-[17px]"> Realar help you easily create a real estate trading website. With the
                        function Register, Login, Post real estate news.
                    </div>
                </div>
                <div class="w-full lg:w-1/2 p-3 flex justify-end">
                    <a href="javascript:void(0)"
                    ...
                    <div class="w-full lg:py-16 xl:py-0 lg:pe-16 lg:flex justify-start items-end">
                        ...
                        <div
                            ...
                            <q> Home is where love resides, memories are created, and dreams are nurtured. I have found
                                my sanctuary in this beautiful property. Finding the perfect that resonates with your
                                own </q>
    ...
    <section class="w-full py-5 sm:py-10 bg-[#364440]">
        <div class="mx-auto lg:max-w-[1000px] xl:max-w-[1400px] px-3 py-2 sm:px-2 sm:py-0">
            <div class="w-full py-5 sm:py-10 flex flex-wrap items-center">
                <div class="w-full lg:w-1/2 p-3">
                    <div
                        class="text-[35px] xl:text-[45px] leading-[40px] xl:leading-[70px] text-white mb-5 font-semibold">
                        News & Articles
                    </div>
                    <div class="text-[17px] text-white"> Realar help you easily create a real estate trading website.
