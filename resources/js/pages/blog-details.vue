<template>
    ...
    <section class="w-full">
        <div class="mx-auto w-full lg:w-[1000px] px-5 lg:px-0">
            ...
            <div class="text-gray-600 text-[13px] mb-5">
            ...
            <div class="mb-5 border-l-4 border-l-blue-500 p-5 text-[13px] bg-gray-200">
            ...
            <div class="text-gray-600 text-[13px] mb-5">
                ...
                <ul class="list-disc ps-5">
                    ...
                    <li class="my-2"> Lorem ipsum dolor sit amet, consectetuer adipiscing elit. </li>

                    <ul class="list-decimal my-2 ps-5">
                        <li class="my-2"> Aliquam tincidunt mauris eu risus. </li>
                        <li class="my-2"> Lorem ipsum dolor sit amet, consectetuer adipiscing elit. </li>
                    </ul>
                    ...
                    <ul class="list-decimal my-2 ps-5">
                        <li class="my-2"> Aliquam tincidunt mauris eu risus. </li>
                        <li class="my-2"> Vestibulum auctor dapibus neque. </li>
                    </ul>
            ...
            <div class="text-gray-600 text-[13px] mb-10">
            ...
            <div class="mx-auto w-2/3 mb-10">
                <img :src="'/images/properties-2.jpg'" class="object-cover bg-cover w-full min-h-[300px]" alt="properties">
            </div>
            ...
            <div class="border-b-2 border-b-gray-300 w-full"></div>
            ...
            <form class="w-full flex flex-wrap p-5 sm:p-10 border border-gray-300 rounded-lg">
                ...
                <div class="w-full sm:w-1/2 sm:pe-3 mb-3">
                    ...
                    <input type="text" id="blog-name" name="name" placeholder="Enter your name" class="text-[13px] h-[42px] rounded-md w-full outline-0 border border-gray-300 focus-visible:border-blue-900 duration-500 px-3 py-2" required autocomplete="off">
                </div>
                ...
                <div class="w-full mb-3">
                    ...
                    <textarea name="message" id="blog-message" class="text-[13px] rounded-md w-full outline-0 border border-gray-300 focus-visible:border-blue-900 duration-500 px-3 py-2" cols="30" rows="10" required autocomplete="off"></textarea>
                </div>
