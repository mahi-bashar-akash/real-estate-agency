        ...
        <div class="mx-auto w-full lg:w-[1000px] px-5 lg:px-0">
            ...
            <form class="w-full flex flex-wrap p-5 sm:p-10 border border-gray-300 rounded-lg">
                ...
                <div class="w-full sm:w-1/2 sm:pe-3 mb-3">
                    ...
                    <input type="text" id="blog-name" name="name" placeholder="Enter your name" class="text-[13px] h-[42px] rounded-md w-full outline-0 border border-gray-300 focus-visible:border-blue-900 duration-500 px-3 py-2 placeholder-slate-700" required autocomplete="off">
                </div>

                <div class="w-full sm:w-1/2 mb-3">
                    <label for="blog-email" class="block mb-1 w-full">Email</label>
                    <input type="email" id="blog-email" name="email" placeholder="Enter your email" class="text-[13px] h-[42px] rounded-md w-full outline-0 border border-gray-300 focus-visible:border-blue-900 duration-500 px-3 py-2 placeholder-slate-700" required autocomplete="off">
                </div>
