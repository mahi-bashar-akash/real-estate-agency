<template>
    ...
    <form @submit.prevent="reset()" class="w-full">
        <div class="mb-3 w-full">
            <label for="password" class="flex justify-between items-center mb-1"> New Password </label>
            <div class="w-full relative">
                <input id="password" :type="newPasswordFieldType" name="password" placeholder="Enter your password" v-model="formData.password" class="rounded-md duration-500 focus-visible:border-blue-600 w-full px-3 py-2 outline-0 border border-gray-300" autocomplete="off" />
        ...
        <div class="mb-3 w-full">
            <label for="password-confirmation" class="flex justify-between items-center mb-1"> Confirm New Password </label>
            <div class="w-full relative">
                <input id="password-confirmation" :type="confirmNewPasswordFieldType" name="password_confirmation" placeholder="Enter your password confirmation" v-model="formData.password_confirmation" class="rounded-md duration-500 focus-visible:border-blue-600 w-full px-3 py-2 outline-0 border border-gray-300" autocomplete="off" />
                <div class="absolute end-0 top-0 bottom-0 pe-3">
