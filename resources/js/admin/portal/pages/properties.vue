<template>
    ...
    <div class="px-3 md:px-5">
        <div class="bg-gray-200 px-3 md:px-7 py-3 md:py-5 rounded-2xl w-full">
            ...
            <div class="flex justify-between items-center mb-3">
                ...
                <!-- button -->
                <a href="javascript:void(0)" @click="openManageModal()"
    ...
    <div class="fixed inset-0 size-full flex justify-center items-center duration-500 z-50" :class="{ 'invisible bg-black/35' : !isManageModal, 'visible bg-black/65' : isManageModal }" @click="isManageModal = false">
        <form @submit.prevent="manageApi()" class="bg-white rounded-2xl w-full max-w-[550px] p-5 duration-500 origin-top" :class="{ '-translate-y-1/2 opacity-0' : !isManageModal, 'translate-y-0 opacity-100' : isManageModal }" @click.stop>
            <div class="flex justify-between items-center mb-3">
                <div class="text-[22px]"> <span v-if="id === null"> Create </span> <span v-if="id !== null"> Edit </span> Property </div>
            ...
            <div class="w-full mb-3">
                ...
                <div class="mb-3 w-full">
                    <label for="property-title" class="block mb-1 w-full"> Property Title: </label>
                    <input id="property-title" type="text" name="property-title" class="w-full px-4 py-3 outline-0 border border-gray-300 block rounded-lg duration-500 focus-within:border-blue-800" required autocomplete="off" />
                </div>
                <div class="mb-3 w-full">
                    <label for="property-size" class="block mb-1 w-full"> Property Size: </label>
                    <input id="property-size" type="text" name="property-size" class="w-full px-4 py-3 outline-0 border border-gray-300 block rounded-lg duration-500 focus-within:border-blue-800" required autocomplete="off" />
                </div>
                <div class="mb-3 w-full">
