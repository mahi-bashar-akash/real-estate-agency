                        ...
                        <div class="decoration-0 w-full">
                            <div
                                ...
                                <div class="absolute top-0 end-0 p-3">
                                    <button type="button" class="bg-gray-200 duration-500 hover:bg-gray-600 group outline-0 border-0 size-[45px] rounded-lg inline-flex justify-center items-center">
