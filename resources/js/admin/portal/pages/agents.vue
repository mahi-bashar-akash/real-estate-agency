        ...
        <div class="bg-gray-200  px-7 py-5 rounded-2xl w-full">
            ...
            <div class="flex justify-between items-center mb-3">
                ...
                <a href="javascript:void(0)"
                   class="bg-[#1c252e] text-white px-10 py-3 rounded-2xl opacity-100 duration-500 hover:opacity-90">
                    Add
                </a>
                            ...
                            <div
                                ...
                                <div class="w-full p-7 pt-0 flex justify-between flex-col">
                                    <div class="text-[13px]">
                                        ...
                                        <div class="flex justify-start items-center gap-1 flex-wrap md:flex-nowrap mt-3">
                                            <button type="button"
