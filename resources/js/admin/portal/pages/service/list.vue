<template>
    ...
    <div class="px-3 md:px-5">
        <div class="bg-gray-200 p-3  rounded-2xl w-full">
            ...
            <div class="flex justify-between items-center mb-3">
                ...
                <!-- title -->
                <div class="text-[25px]"> Services </div>

                <!-- button -->
                <router-link :to="{name:'manageService',params:{id:'new'}}" class="bg-[#1c252e] outline-none border-0 text-white rounded-xl opacity-100 duration-500 hover:opacity-75 h-[45px] w-[100px] text-[15px] inline-flex justify-center items-center">
                    Add
                </router-link>
                                ...
                                <div class="absolute top-0 end-0 p-3">
                                    <div class="relative">
                                        ...
                                        <ul class="absolute top-auto end-0 w-[150px] bg-white drop-shadow-xl border p-1 rounded-xl"
                                            ...
                                            <li>
                                                <router-link :to="{name:'viewService',params:{id:index}}" class="decoration-0 flex justify-start items-center px-4 py-2 duration-500 bg-transparent hover:bg-gray-200 rounded-xl">
                                            ...
                                            <li>
                                                <router-link :to="{name:'manageService',params:{id:index}}" class="decoration-0 flex justify-start items-center px-4 py-2 duration-500 bg-transparent hover:bg-gray-200 rounded-xl">
                                                    <span class="min-w-[30px] inline-flex justify-start items-center">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-[20px]">
    ...
    <!-- manage modal -->
    <div class="fixed inset-0 size-full grid sm:justify-center items-center duration-500 z-50 overflow-y-auto scrollbar p-2 md:p-16" :class="{ 'invisible bg-black/35' : !isManageModal, 'visible bg-black/65' : isManageModal }" @click="isManageModal = false">
        <form @submit.prevent="manageApi()" class="bg-white rounded-2xl min-w-full sm:min-w-[550px] p-5 sm:p-10 duration-500 origin-top" :class="{ '-translate-y-1/2 opacity-0' : !isManageModal, 'translate-y-0 opacity-100' : isManageModal }" @click.stop>
            <div class="flex justify-between items-center mb-3">
                <div class="text-[22px]"> <span v-if="id === null"> Create </span> <span v-if="id !== null"> Edit </span> Service </div>
            ...
            <div class="w-full mb-3">
                ...
                <div class="mb-3 w-full">
                    <label for="service-title" class="block mb-1 w-full"> Service Title: </label>
                    <input id="service-title" type="text" name="service-title" class="w-full px-4 py-3 outline-0 border border-gray-300 block rounded-lg duration-500 focus-within:border-blue-800" required autocomplete="off" />
                </div>
                <div class="mb-3 w-full">
                    <label for="service-tag" class="block mb-1 w-full"> Service Tag: </label>
                    <input id="service-tag" type="text" name="service-tag" class="w-full px-4 py-3 outline-0 border border-gray-300 block rounded-lg duration-500 focus-within:border-blue-800" required autocomplete="off" />
                </div>
                <div class="w-full">
                    <label for="service-description" class="block mb-1 w-full"> Service Description: </label>
                    <textarea name="service-description" id="service-description" cols="30" rows="5" class="w-full p-4 outline-0 border border-gray-300 block rounded-lg" required autocomplete="off"></textarea>
                </div>
            </div>
