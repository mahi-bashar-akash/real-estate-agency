<template>
    ...
    <form @submit.prevent="logIn()" class="w-full mx-auto max-w-[470px] p-5 sm:p-10 bg-white/45 backdrop-blur-md shadow-[0_0_16px_#888888]">
            ...
            <div class="relative w-full">
                ...
                <div class="absolute end-0 top-0 bottom-0 pe-3">
                    <button type="button" class="bg-transparent border-0 group outline-0 size-[25px] flex justify-end items-center h-full" @click="passwordVisibility()">
                        <svg viewBox="0 0 24 24" class="size-[25px]" fill="none" xmlns="http://www.w3.org/2000/svg" v-if="passwordFieldType === 'text'">
                        ...
                        <svg viewBox="0 0 24 24" class="size-[25px]" fill="none" xmlns="http://www.w3.org/2000/svg" v-if="passwordFieldType === 'password'">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
