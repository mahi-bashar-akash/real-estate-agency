<template>
    ...
    <form @submit.prevent="signUp()" class="w-full">
        ...
        <div class="mb-3 w-full">
            ...
            <input id="confirm-password" type="password" name="confirm-password" placeholder="Enter your confirm password" class="rounded-md w-full px-3 py-2 outline-0 border border-gray-300" required autocomplete="off" />
        </div>
        <div class="mb-3 w-full">
